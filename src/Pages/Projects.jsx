  ...
  const cardItem = [
    {
      ...
      visitapp: "https://app-mern-blog-100.onrender.com/",
      sourceCode: "https://github.com/krunal-ar-panhal/app-mern-blog.git",
    },
  ];
      ...
      <div>
        <div className="bg-zinc-300 md:min-h-screen h-auto pb-9">
          <div className="md:max-w-6xl md:mx-auto ml-4 mr-4 ">
            <h1 className="md:text-4xl text-2xl font-semibold pt-10">
              Projects
            </h1>
            <div className="flex flex-col gap-10 mt-10 md:grid md:grid-cols-3 ">
              {cardItem.map(({ id, logo, name, visitapp, sourceCode }) => (
                <div
